...
class CNN:
    ...
    def fit(self):
        ...
        self.b_offset = tf.Variable(tf.constant(0.0, shape=[32]))
        print("-----------------", self.weight)
...
def cnn_run():
    ...
    # mnist.train.images是一个55000 * 784维的矩阵, mnist.train.labels是一个55000 * 10 维的矩阵
    ...
    tr_x = tr_x.reshape(-1, 28, 28, 1)  # 将每张图片用一个28 * 28的矩阵表示, (55000, 28, 28, 1)
